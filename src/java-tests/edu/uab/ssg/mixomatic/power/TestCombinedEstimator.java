...
public final class TestCombinedEstimator extends TestCase {
	...
	public void testCR() {
		...
		estimate = estimator.calculateEstimates(3, 0.1, 100);
	...
	public void testMountz() {
		...
		// Extrapolate to smaller sample size.
		estimate = estimator.calculateEstimates(2, 0.1, 100);
	...
	public void testCD4() {
		...
		// Extrapolate to smaller sample size.
		estimate = estimator.calculateEstimates(4, 0.1, 100);
	...
	public void testObesity() {
		...
		// Extrapolate to smaller sample size.
		estimate = estimator.calculateEstimates(10, 0.1, 100);
