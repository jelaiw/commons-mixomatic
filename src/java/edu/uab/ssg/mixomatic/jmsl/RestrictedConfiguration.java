...
public final class RestrictedConfiguration extends DefaultConfiguration {
	/* package private */ RestrictedConfiguration() {
		// Redefine the lower and upper bounds for this "restricted" model.
		...
		// Redefine the grid search space.
